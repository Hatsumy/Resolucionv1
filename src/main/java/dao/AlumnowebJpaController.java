...
public class AlumnowebJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.mycompany_Resolucionv1_war_1.0-SNAPSHOTPU");
    ...
    public Alumnoweb findAlumnoByDNI(String dni) {
        EntityManager em = getEntityManager();
        try {
    ...
    public Alumnoweb findAlumnoByUsername(String username) {
        EntityManager em = getEntityManager();
        try {
            Query query = em.createNamedQuery("Alumnoweb.findByLogiEstd");
    ...
    public static void main(String[] args) {
        ...
        Alumnoweb alu = aluDAO.findAlumnoByDNI("75689638");
        System.out.println(alu.getNombEstdWeb());
